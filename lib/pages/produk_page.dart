      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(ctx);
              final res = await ApiService.deleteProduct(prod['id'].toString());
              _snack(
                res['message'] ?? 'Selesai',
                success: res['success'] == true,
              );
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            ..._categories.map(
                              (c) => _filterChip(c['name'], c['id'].toString()),
                            ),
                          ],
                        ),
                      ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // FIX: Bungkus nama kategori dengan Expanded dan beri ellipsis
                Expanded(
                  child: Text(

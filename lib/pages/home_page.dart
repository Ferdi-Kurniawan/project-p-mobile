    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [_buildSectionLabel("Jelajahi Kategori")],
          ),
            ...
            children: _quickMenu.asMap().entries.map((entry) {
              ...
              return TweenAnimationBuilder<double>(
                ...
                child: GestureDetector(
                  onTap: () => setState(
                    () => _selectedKategori = item['label'] as String == 'Foto'
                        ? 'Semua'
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (_, animation, __) => DetailWisataPage(data: village),

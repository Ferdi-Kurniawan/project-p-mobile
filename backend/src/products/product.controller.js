...
const createProduct = async (req, res) => {
    ...
    const existingCategory = await categoriesRepository.getCategoryById(category_id)
    ...
    return res.status(200).json({ message: "data berhasil di buat", data: {
        product
    } })
...
const updateProductById = async(req, res) => {
    ...
    await productRepository.updateProductById(productId, category_id, { name, price })
